...
```javascript
import { dcityblock, dcosineDistance, dcosineSimilarity, deuclidean, dsquaredEuclidean } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-distances@esm/index.mjs';
```
