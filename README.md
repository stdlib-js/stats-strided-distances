...
```javascript
import { dcityblock, dcosineDistance, dcosineSimilarity, deuclidean, dsquaredEuclidean } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-distances@deno/mod.js';
```
