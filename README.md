...
```javascript
import { dchebychev, dcityblock, dcosineDistance, dcosineSimilarity, deuclidean, dsquaredEuclidean } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-distances@v0.1.1-deno/mod.js';
```
